...
*--working-dir*::
  Commodore will create a whole bunch of directories and files.
  By default, this happens within the current working directory.
  Setting option, makes commodore create them at the provided location.
