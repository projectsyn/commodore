...
This file must be placed at the root of the components file structure.
...
If your component require a specific version, you have to declare this in the `version` field within `jsonnetfile.json`.
====
